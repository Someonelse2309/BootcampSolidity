...
import type { Chain, CrashRecoveryCheckpoint, Event, Filter, IndexingBuild, LightBlock, RawEvent, Seconds, Source, SyncBlock } from '../internal/types.js';
 ...
 */
export declare const getChainCheckpoint: <tag extends "finalized" | "start" | "end" | "current">({ syncProgress, chain, tag, }: {
