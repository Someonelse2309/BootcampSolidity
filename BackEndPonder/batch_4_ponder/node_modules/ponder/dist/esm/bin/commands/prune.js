...
import { VIEWS, createDatabase, getPonderMetaTable, } from '../../database/index.js';
...
export async function prune({ cliOptions }) {
    ...
    if (viewsToDrop.length > 0) {
        await database.qb.drizzle.execute(sql.raw(`DROP VIEW IF EXISTS ${viewsToDrop.join(", ")} CASCADE`));
        logger.warn({
            service: "prune",
