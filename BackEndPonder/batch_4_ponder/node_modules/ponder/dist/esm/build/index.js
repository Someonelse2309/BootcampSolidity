    ...
    const build = {
        ...
        async executeApi({ indexingBuild, database }) {
            ...
            if (!fs.existsSync(common.options.apiFile)) {
                const error = new BuildError(`API endpoint file not found. Create a file at ${common.options.apiFile}. Read more: https://ponder.sh/docs/api-reference/ponder/api-endpoints`);
            ...
            if (!(app instanceof Hono || app?.constructor?.name === "Hono")) {
                const error = new BuildError("API endpoint file does not export a Hono instance as the default export. Read more: https://ponder.sh/docs/api-reference/ponder/api-endpoints");
                error.stack = undefined;
                common.logger.error({
                    service: "build",
                    msg: "Failed build",
        ...
        namespaceCompile() {
            if (cliOptions.schema === undefined &&
                ...
                const error = new BuildError("Database schema required. Specify with 'DATABASE_SCHEMA' env var or '--schema' CLI flag. Read more: https://ponder.sh/docs/database#database-schema");
                error.stack = undefined;
                common.logger.error({
                    service: "build",
                    msg: "Failed build",
            ...
            const viewsSchema = cliOptions.viewsSchema ?? process.env.DATABASE_VIEWS_SCHEMA;
        ...
        async compileIndexing({ configResult, schemaResult, indexingResult }) {
            ...
            return {
                ...
                result: {
                    ...
                    finalizedBlocks: buildConfigAndIndexingFunctionsResult.finalizedBlocks,
