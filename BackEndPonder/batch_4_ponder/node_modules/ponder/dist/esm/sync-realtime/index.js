            ...
            for (const log of logs) {
                ...
                if (transaction === undefined) {
                    if (log.transactionHash === zeroHash) {
                        ...
                        throw new Error(`Detected inconsistent '${args.chain.name}' RPC responses. 'log.transactionHash' ${log.transactionHash} not found in 'block.transactions' ${block.hash}`);
                    }
                }
                else {
                    if (transaction.transactionIndex !== log.transactionIndex) {
                        throw new Error(`Detected inconsistent '${args.chain.name}' RPC responses. 'log.transactionIndex' ${log.transactionIndex} not found in 'block.transactions' ${block.hash}`);
                    }
                }
            }
        }
