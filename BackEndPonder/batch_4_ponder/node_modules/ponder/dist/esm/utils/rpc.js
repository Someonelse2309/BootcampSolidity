 ...
 */
export const _eth_getBlockByNumber = (rpc, { blockNumber, blockTag, }) => rpc
    .request({
 ...
 * Helper function for "eth_getBlockByNumber" request.
 */
export const _eth_getBlockByHash = (rpc, { hash }) => rpc
    .request({
 ...
 */
export const _eth_getLogs = async (rpc, params) => {
 ...
 */
export const _eth_getTransactionReceipt = (rpc, { hash }) => rpc
    .request({
 ...
 */
export const _eth_getBlockReceipts = (rpc, { blockHash }) => rpc
    .request({
 ...
 */
export const _debug_traceBlockByNumber = (rpc, { blockNumber, }) => rpc
    .request({
 ...
 */
export const _debug_traceBlockByHash = (rpc, { hash, }) => rpc
    .request({
